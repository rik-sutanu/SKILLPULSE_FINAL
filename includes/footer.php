  ...
  <footer class="site-footer" role="contentinfo">
    <div class="container">
      <div class="footer-grid">
        <div class="footer-col">
          <div style="display:flex;align-items:center;gap:0.75rem;margin-bottom:1rem;">
            <div class="brand-icon" style="width:34px;height:34px;" aria-hidden="true">
          ...
          <div style="display:flex;gap:0.5rem;align-items:center;">
            ...
            <span style="font-size:0.75rem;color:var(--cyan-400);">Govt Data Feeds: Live &amp; Operational</span>
          </div>
        </div>
        ...
        <div class="footer-col">
          ...
          <ul>
            <li><a href="how-it-works.php">How It Works (Methodology)</a></li>
            <li><a href="data-sources.php">Data Sources &amp; Pipelines</a></li>
            <li><a href="skill-intelligence.php">Skill Intelligence</a></li>
            <li><a href="skill-gap-analyzer.php">Skill Gap Analyzer (React)</a></li>
            <li><a href="training-curriculum.php">Curriculum Simulator (React)</a></li>
            <li><a href="government.php">Maharashtra &amp; Regional Portal</a></li>
          </ul>
        </div>
        ...
        <div class="footer-col">
          ...
          <ul>
            <li><a href="courses.php">Bridging Courses</a></li>
            <li><a href="practice.php">Practice Arena (React)</a></li>
            <li><a href="experts.php">1-on-1 Mentors</a></li>
            <li><a href="dashboard.php">Student Dashboard</a></li>
            <li><a href="institution-dashboard.php">Institution Dashboard</a></li>
            <li><a href="employer-dashboard.php">Employer Dashboard</a></li>
            <li><a href="auth.php">Sign In / Register</a></li>
      ...
      <!-- Statutory Government Security & Privacy Notice Bar -->
      <div style="margin-top:2rem;padding-top:1.5rem;border-top:1px solid rgba(255,255,255,0.08);display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:1rem;font-size:0.8rem;color:var(--navy-500);">
        <div style="display:flex;gap:1rem;flex-wrap:wrap;align-items:center;">
          <span>🔒 <strong>Data Sovereignty:</strong> Hosted exclusively in MeitY-Empanelled Cloud Data Centers (Republic of India)</span>
          <span>•</span>
          <span><strong>Statutory Standard:</strong> Digital Personal Data Protection Act (DPDP Act, 2023)</span>
          <span>•</span>
          <span><strong>Cybersecurity:</strong> CERT-In 180-Day Audit Logging Enforced</span>
        </div>
        <div>
          <a href="privacy.php#dpo-grievance" style="color:var(--secondary-accent, #D6B94D);text-decoration:underline;">Citizen Data Rights &amp; DPO Grievance Portal &rarr;</a>
        </div>
      </div>

      <div class="footer-bottom">
        <span>© 2026 SkillPulse TVET Alignment Platform. All rights reserved. <a href="how-it-works.php" style="text-decoration:underline;color:var(--navy-400);">Architecture &amp; Stack</a></span>
        <span>Directorate of Vocational Education &amp; Training (DVET) &bull; Government of Maharashtra</span>
      </div>
    </div>
  </footer>

  <!-- Scripts: Data layer, Main App Controller, React Components, PulseAI Copilot, Welcome Banner -->
